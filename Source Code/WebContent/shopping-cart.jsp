...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <table class="table table-hover table-responsive table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <td>$10</td>
                    <td><input type="number" value="1" min="1" class="col-4"></td>
                    <td>$10</td>
                ...
                <tr>
                    ...
                    <td>$10</td>
                    <td><input type="number" value="2" min="1" class="col-4"></td>
                    <td>$20</td>
                    <td><a href="#">Remove</a></td>
                </tr>
                <tr>
        ...
        <div class="row">
            <div class="col-4"><button type="button" class="btn btn-link">Update</button></div>
            <div class="col-4"><button type="button" class="btn btn-link">Continue shopping</button></div>
            <div class="col-4"><a href="./checkout.jsp"><button type="button" class="btn btn-success">Check out</button></a></div>
        </div>
    </div>
